...
RAW_DATA_PATH = DATA_DIR / "raw" / "ukdale_unified.csv"
PROCESSED_DATA_PATH = DATA_DIR / "processed" / "ukdale_unified_fixed.csv"

# Active dataset paths configuration - add or remove datasets here
...
# Raw dataset category mapping to taxonomy
RAW_CATEGORY_MAP = {
    ...
    "water": INTERNAL_CATEGORY_WATER_HEATER,  # Note: UK-DALE has zero valid appliances for water
