...
export const simulatedDashboards: Record<HouseholdOption['id'], DashboardData> =
  {
    'high-ac-home': {
      ...
      simulationScenario: 'Heatwave cooling day',
      simulationSeed: 10101,
      simulationConfiguration: { mode: 'surprise' },
      simulationEvents: [],
      simulated: true,
    ...
    'efficient-flat': {
      ...
      simulationScenario: 'Efficient weekday routine',
      simulationSeed: 20202,
      simulationConfiguration: { mode: 'surprise' },
      simulationEvents: [],
      simulated: true,
    ...
    'family-villa': {
      ...
      simulationScenario: 'Family school day',
      simulationSeed: 30303,
      simulationConfiguration: { mode: 'surprise' },
      simulationEvents: [],
      simulated: true,
